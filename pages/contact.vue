  ...
  <div class="contact-container">
    <div class="global-contact-page">
      ...
      <div class="map-and-anchor-container" id="map-anchor">
        <NuxtLink to="/contact/#form-anchor" id="scroll-to-form">Nous écrire </NuxtLink>
...
const onSubmit = async (values) => {
  ...
  try {
    const mail = useMail();
    mail.send({
      from: `La société ${bodyContent.company}`,
      subject: "Message envoyé depuis le site web sgconseils.com",
      text: `
      Mme / Mr ${bodyContent.lastname}
      Mail de l'expéditeur: ${bodyContent.email}
      Message de la personne: ${bodyContent.message}
      `,
    });
